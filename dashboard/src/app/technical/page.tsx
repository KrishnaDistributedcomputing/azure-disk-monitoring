...
const ALL_METRICS = [
  // Platform metrics
  { name: 'Data Disk Read Bytes/sec', source: 'Platform', category: 'Throughput', unit: 'Bytes/sec', description: 'Bytes read from data disks per second', dashboard: 'Throughput tab, time series chart', costRelevance: 'Bandwidth consumed % → right-size throughput provisioning' },
  { name: 'Data Disk Write Bytes/sec', source: 'Platform', category: 'Throughput', unit: 'Bytes/sec', description: 'Bytes written to data disks per second', dashboard: 'Throughput tab, time series chart', costRelevance: 'Same as above' },
  { name: 'Data Disk Read Operations/sec', source: 'Platform', category: 'IOPS', unit: 'Count/sec', description: 'Read operations per second on data disks', dashboard: 'IOPS tab, VM comparison chart', costRelevance: 'IOPS consumed % → right-size disk tier' },
  { name: 'Data Disk Write Operations/sec', source: 'Platform', category: 'IOPS', unit: 'Count/sec', description: 'Write operations per second on data disks', dashboard: 'IOPS tab, VM comparison chart', costRelevance: 'IOPS consumed % → right-size disk tier' },
  { name: 'Data Disk Queue Depth', source: 'Platform', category: 'Saturation', unit: 'Count', description: 'Number of pending I/O operations on data disks', dashboard: 'Queue Depth tab, time series', costRelevance: 'High QD → upgrade signal → cost increase' },
  { name: 'Data Disk Latency', source: 'Platform', category: 'Latency', unit: 'ms', description: 'Average latency per operation on data disks', dashboard: 'Latency tab, percentile chart', costRelevance: 'High latency → tier upgrade needed' },
  { name: 'Data Disk IOPS Consumed %', source: 'Platform', category: 'Saturation', unit: '%', description: 'Percentage of provisioned IOPS being consumed', dashboard: 'Monitor → disk gauge', costRelevance: '<50% = over-provisioned = wasted spend' },
  { name: 'Data Disk Bandwidth Consumed %', source: 'Platform', category: 'Saturation', unit: '%', description: 'Percentage of provisioned throughput consumed', dashboard: 'Monitor → disk progress bar', costRelevance: '<50% = reduce PremV2 throughput → save $/mo' },
  { name: 'VM Uncached IOPS Consumed %', source: 'Platform', category: 'Saturation', unit: '%', description: 'How much of the VM-level IOPS cap is used', dashboard: 'Monitor → VM gauge', costRelevance: '>85% = VM bottleneck → larger VM needed' },
  { name: 'VM Uncached BW Consumed %', source: 'Platform', category: 'Saturation', unit: '%', description: 'How much of the VM-level throughput cap is used', dashboard: 'Monitor → VM gauge', costRelevance: '>85% = VM bottleneck → larger VM needed' },
  { name: 'OS Disk Read/Write Bytes/sec', source: 'Platform', category: 'Throughput', unit: 'Bytes/sec', description: 'Throughput on the OS disk', dashboard: 'Monitor → disk detail', costRelevance: 'Usually low — P10 ($9.86/mo) is sufficient' },
  { name: 'OS Disk Queue Depth', source: 'Platform', category: 'Saturation', unit: 'Count', description: 'Queue depth on OS disk', dashboard: 'Monitor → disk detail', costRelevance: 'High OS QD → slow VM boot/login' },
  { name: 'Premium SSD Burst IO Credits', source: 'Platform', category: 'Burst', unit: 'Credits', description: 'Remaining burst IOPS credits (P10-P20 only)', dashboard: 'Monitor → disk burst gauge', costRelevance: 'Free performance — use before upgrading tier' },
  { name: 'Premium SSD Burst BPS Credits', source: 'Platform', category: 'Burst', unit: 'Credits', description: 'Remaining burst throughput credits', dashboard: 'Monitor → disk burst gauge', costRelevance: 'Free throughput — avoids tier upgrade' },
  // Guest metrics (AMA via DCR)
  { name: 'Disk Transfers/sec', source: 'AMA (Guest)', category: 'IOPS', unit: 'ops/sec', description: 'Total read+write operations per second per disk instance', dashboard: 'IOPS tab, inventory table', costRelevance: 'Maps to IOPS consumed; right-size provisioning' },
  { name: 'Disk Bytes/sec', source: 'AMA (Guest)', category: 'Throughput', unit: 'Bytes/sec', description: 'Total combined throughput per disk instance', dashboard: 'Throughput tab, inventory table', costRelevance: 'Maps to bandwidth consumed' },
  { name: 'Avg. Disk sec/Read', source: 'AMA (Guest)', category: 'Latency', unit: 'seconds', description: 'Average time per read operation (×1000 for ms)', dashboard: 'Latency tab, percentile chart', costRelevance: 'Latency drives tier selection' },
  { name: 'Avg. Disk sec/Write', source: 'AMA (Guest)', category: 'Latency', unit: 'seconds', description: 'Average time per write operation', dashboard: 'Latency tab, percentile chart', costRelevance: 'Write latency critical for DB workloads' },
  { name: 'Current Disk Queue Length', source: 'AMA (Guest)', category: 'Saturation', unit: 'Count', description: 'Instantaneous queue depth at sample time', dashboard: 'Queue Depth tab', costRelevance: 'Sustained >32 = upgrade needed' },
  { name: '% Used Space', source: 'AMA (Guest)', category: 'Capacity', unit: '%', description: 'Percentage of disk space consumed', dashboard: 'Capacity tab, gauge cards', costRelevance: 'Overprov: paying for unused GiB' },
  { name: 'Free Megabytes', source: 'AMA (Guest)', category: 'Capacity', unit: 'MB', description: 'Absolute free space remaining', dashboard: 'Capacity tab, inventory', costRelevance: 'Plan growth vs emergency upsizing' },
  { name: '% Free Inodes', source: 'AMA (Guest)', category: 'Capacity', unit: '%', description: 'Inode utilization on Linux (can fill with space remaining)', dashboard: 'Not shown by default', costRelevance: 'Inode exhaustion → app failures' },
  { name: 'Disk Reads/sec', source: 'AMA (Guest)', category: 'IOPS', unit: 'ops/sec', description: 'Read operations per second per disk instance', dashboard: 'IOPS tab breakdown', costRelevance: 'Read-heavy → caching optimization' },
  { name: 'Disk Writes/sec', source: 'AMA (Guest)', category: 'IOPS', unit: 'ops/sec', description: 'Write operations per second per disk instance', dashboard: 'IOPS tab breakdown', costRelevance: 'Write-heavy → disable caching, consider Ultra' },
];
            ...
            <div className="overflow-x-auto rounded-xl border border-slate-700 bg-slate-800">
              <table className="w-full text-left text-xs">
                <thead><tr className="border-b border-slate-700 text-[10px] uppercase text-slate-400">
                  <th className="px-4 py-3">Metric Name</th><th className="px-4 py-3">Source</th><th className="px-4 py-3">Category</th><th className="px-4 py-3">Unit</th><th className="px-4 py-3">Description</th><th className="px-4 py-3">Shown In</th><th className="px-4 py-3">Cost Relevance</th>
                </tr></thead>
                <tbody>
                  {filteredMetrics.map((m) => (
                    <tr key={m.name} className="border-b border-slate-700/50 hover:bg-slate-700/20">
